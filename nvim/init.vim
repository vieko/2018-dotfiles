...
let g:python_host_prog = '/Users/vieko/.pyenv/versions/neovim2/bin/python'
let g:python3_host_prog = '/Users/vieko/.pyenv/versions/neovim3/bin/python'

source $HOME/nvim/config/plugins.vim
source $HOME/nvim/config/init.vim
